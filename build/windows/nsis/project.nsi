...
Section "uninstall" 
    ...
    IfSilent preserveUserData askDeleteUserData
    askDeleteUserData:
        MessageBox MB_YESNO|MB_ICONQUESTION "Delete MineOps data and logs? Choose No to preserve them for a future installation." IDYES deleteUserData IDNO preserveUserData
    deleteUserData:
