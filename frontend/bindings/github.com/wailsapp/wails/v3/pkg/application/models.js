...
export class SecondInstanceData {
     ...
     * @param {Partial<SecondInstanceData>} [$$source = {}] - The source object to create the SecondInstanceData.
     */
    constructor($$source = {}) {
        if (!("args" in $$source)) {
            /**
    ...
    static createFrom($$source = {}) {
        ...
        return new SecondInstanceData(/** @type {Partial<SecondInstanceData>} */($$parsedSource));
    }
}
